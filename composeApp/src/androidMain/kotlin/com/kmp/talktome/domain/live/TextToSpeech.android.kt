...
// Like the AudioRecorder, this requires a Context.
// This should be provided via your dependency injection framework (Koin).
actual fun getTextToSpeechEngine(): TextToSpeechEngine {
    throw UnsupportedOperationException(
        "TextToSpeechEngine should be instantiated via Koin on Android to provide the required context."
    )
}
