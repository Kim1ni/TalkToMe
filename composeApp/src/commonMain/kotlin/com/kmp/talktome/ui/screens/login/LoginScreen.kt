...
import com.kmp.talktome.ui.screens.login.composables.AuthButton
import com.kmp.talktome.ui.screens.login.composables.OrDivider
        ...
        GoogleButtonUiContainerFirebase(
            onResult = { result ->
                result.onSuccess { user ->
                    user?.let { viewModel.signInWithGoogle(it) }
                }.onFailure { error ->
